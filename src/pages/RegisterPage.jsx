    ...
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center px-4 bg-gradient-bebe-soft">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold gradient-text drop-shadow-sm">Get Started</h1>
          <p className="text-baby-pink-600 dark:text-baby-pink-300 mt-2 font-medium">Create your CommerceX account</p>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-4 bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-xl border-2 border-baby-pink-200 dark:border-baby-pink-700">
          <div>
            <label className="block text-sm font-semibold text-baby-pink-700 dark:text-baby-pink-200 mb-2">Full Name</label>
            <input
              type="text"
              required
              value={name}
          ...
          <div>
            ...
            <input
              ...
              className="input-field"
            />
            <p className="text-xs text-baby-pink-500 dark:text-baby-pink-400 mt-1 font-medium">At least 8 characters</p>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-700 dark:text-slate-300">
            ...
            <Link to="/auth/login" className="text-baby-pink-600 dark:text-baby-pink-400 hover:text-baby-pink-700 dark:hover:text-baby-pink-300 font-bold hover:underline underline-offset-2">
              Sign in
            </Link>
          </p>
        </div>
